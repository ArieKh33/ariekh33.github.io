       ...
       <Container>
          <Row className="align-items-center">
              <Col xs={12} md={6} xl={7}>
                ...
                <button className="p-2 "><a href='mailto:akharamany04@gmail.com' className="text-decoration-none text-dark">Lets talk.</a><ArrowRightCircle className="text-dark" size={25}/></button>
              </Col>
              <Col xs={12} md={6} xl={5}>
